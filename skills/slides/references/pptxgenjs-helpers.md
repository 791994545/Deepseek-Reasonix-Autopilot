...
## When To read_file This

read_file this file when you need helper API details, command examples for the bundled Python scripts, or dependency notes for a slide-generation task.
...
- `getImageDimensions(pathOrData)`: read_file image width, height, type, and aspect ratio.
