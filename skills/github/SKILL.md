---
name: github
description: Interact with GitHub using the `gh` CLI. Comprehensive reference for repositories, issues, PRs, Actions, CI runs, releases, gists, codespaces, and all GitHub operations. Use for issue/PR management, CI monitoring, API queries, and release management.
