...
# ============================================
# CUSTOMIZATION - edit_file these for your project
# ============================================
...
while [ $ITERATION -lt $MAX_ITERATIONS ]; do
  ...
  # read_file guardrails if they exist
  GUARDRAILS_CONTENT=""
...
1. read_file $PRD_FILE and find the first task where passes: false
2. read_file $PROGRESS_FILE for context from previous iterations
3. read_file and follow the Guardrails above - they prevent repeated mistakes
...
EOF
  ...
  claude --print --output-format json --dangerously-skip-permissions \
    "You are in a Ralph loop (fresh-context mode). read_file .claude/ralph-state.local.md for instructions, \
