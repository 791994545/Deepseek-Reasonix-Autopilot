...
3. [Connection & Performance](#3-connection--performance) — **HIGH**
   ...
   - 3.3 [Use Client-Side Caching for Frequently read_file Data](#33-use-client-side-caching-for-frequently-read-data)
...
5. [Redis Query Engine](#5-redis-query-engine) — **HIGH**
   ...
   - 5.6 [write_file Efficient Queries](#56-write-efficient-queries)
...
9. [Clustering & Replication](#9-clustering--replication) — **MEDIUM**
   ...
   - 9.2 [Use read_file Replicas for Read-Heavy Workloads](#92-use-read-replicas-for-read-heavy-workloads)
...
r = redis.Redis(
    host='localhost',
    socket_timeout=5.0,         # read_file/write timeout - tune based on expected operation time
...
### 3.3 Use Client-Side Caching for Frequently read_file Data
...
### 5.6 write_file Efficient Queries
...
### 9.2 Use read_file Replicas for Read-Heavy Workloads
...
# write_file to primary
primary.set("key", "value")

# read_file from replica (eventually consistent)
...
- `@read` - read_file commands

- `@write` - write_file commands
