...
### 4. Create Internal Pre-read_file

```
Notion:notion-create-pages
pages: [{
  properties: {
    title: "Acme Corp Meeting - Pre-read_file (Internal)"
  },
  content: "# Acme Corp Meeting - Pre-read_file (Internal)
...
**Internal Pre-read_file**: Full context for sales team
