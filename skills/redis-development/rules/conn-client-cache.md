---
title: Use Client-Side Caching for Frequently read_file Data
impact: HIGH
impactDescription: Reduces network round-trips for repeated reads
tags: caching, performance, client-side, tracking
description: Use Client-Side Caching for Frequently read_file Data
alwaysApply: true
---

## Use Client-Side Caching for Frequently read_file Data
